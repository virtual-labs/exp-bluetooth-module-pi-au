...
var ve = (t, n, e) =>
  n in t
    ? xe(t, n, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (t[n] = e);
var vn = (t, n, e) => (ve(t, typeof n != "symbol" ? n + "" : n, e), e);
(function () {
...
function Xt(t) {
  ...
  return (
    ...
    bn.hasOwnProperty(n) ? { space: bn[n], local: t } : t
  );
}
function $e(t) {
  return function () {
...
function Me(t) {
  typeof t == "function" ? (t = Te(t)) : (t = Yn(t));
...
function Be(t) {
  return this.select(t == null ? Re : Se(typeof t == "function" ? t : Un(t)));
}
...
function Ge(t) {
  return this.selectAll(
    t == null ? De : Oe(typeof t == "function" ? t : Un(t))
  );
}
function Xe(t) {
...
function Ue(t, n) {
  ...
  for (
    ...
    var u = r[l],
      h = i[l],
      f = h.length,
      p = ze(t.call(u, u && u.__data__, l, r)),
      y = p.length,
      _ = (c[l] = new Array(y)),
      N = (s[l] = new Array(y)),
      K = (a[l] = new Array(f));
    e(u, h, _, N, K, p, n);
    for (var M = 0, P = 0, d, m; M < y; ++M)
      if ((d = _[M])) {
        for (M >= P && (P = M + 1); !(m = N[P]) && ++P < y; );
        d._next = m || null;
      }
  }
...
function mr(t, n, e) {
  return arguments.length > 1
    ? this.each(
        (n == null ? dr : typeof n == "function" ? gr : pr)(t, n, e ?? "")
      )
    : tt(this.node(), t);
}
function tt(t, n) {
  return (
    ...
    Wn(t).getComputedStyle(t, null).getPropertyValue(n)
  );
}
function yr(t) {
  return function () {
...
function vr(t, n) {
  return arguments.length > 1
    ? this.each((n == null ? yr : typeof n == "function" ? xr : _r)(t, n))
    : this.node()[t];
}
function Kn(t) {
...
function $r(t, n) {
  var e = Kn(t + "");
  if (arguments.length < 2) {
    for (var r = an(this.node()), i = -1, o = e.length; ++i < o; )
      if (!r.contains(e[i])) return !1;
    return !0;
  }
  return this.each((typeof n == "function" ? Er : n ? wr : br)(e, n));
}
function Ir() {
  this.textContent = "";
}
...
function Nr(t) {
  return arguments.length
    ? this.each(t == null ? Ir : (typeof t == "function" ? Cr : kr)(t))
...
function Pr(t) {
  return arguments.length
    ? this.each(t == null ? Ar : (typeof t == "function" ? Mr : Tr)(t))
    : this.node().innerHTML;
}
function Sr() {
...
function Gr(t, n) {
  var e = typeof t == "function" ? t : Fn(t),
    r = n == null ? Or : typeof n == "function" ? n : cn(n);
  return this.select(function () {
...
function Zr(t, n, e) {
  ...
  for (c = n ? Kr : Wr, i = 0; i < o; ++i) this.each(c(r[i], n, e));
  return this;
}
function jn(t, n, e) {
  var r = Wn(t),
...
function jr(t, n) {
  return this.each((typeof n == "function" ? Jr : Qr)(t, n));
}
function* ti() {
  for (var t = this._groups, n = 0, e = t.length; n < e; ++n)
...
function mt() {
  return new $([[document.documentElement]], te);
}
function ni() {
  return this;
}
...
function ii(t) {
  var n = t.document.documentElement,
    e = E(t).on("dragstart.drag", J, ut);
  "onselectstart" in n
    ? e.on("selectstart.drag", J, ut)
...
function ui() {
  ...
  function p(d, m) {
    if (!(u || !t.call(this, d, m))) {
      var x = P(this, n.call(this, d, m), d, m, "mouse");
      x &&
        (E(d.view).on("mousemove.drag", y, ut).on("mouseup.drag", _, ut),
        ii(d.view),
        qt(d),
        (l = !1),
        (c = d.clientX),
  ...
  function N(d, m) {
    if (t.call(this, d, m)) {
      var x = d.changedTouches,
        ...
        Z;
      for (G = 0; G < I; ++G)
        (Z = P(this, v, d, m, x[G].identifier, x[G])) &&
          (qt(d), Z("start", d, x[G]));
    }
  }
  function K(d) {
    var m = d.changedTouches,
      ...
      I;
    for (v = 0; v < x; ++v)
      (I = i[m[v].identifier]) && (J(d), I("drag", d, m[v]));
  }
  function M(d) {
    var m = d.changedTouches,
      x = m.length,
    ...
    for (
      ...
      (I = i[m[v].identifier]) && (qt(d), I("end", d, m[v]));
  }
  function P(d, m, x, v, I, G) {
    var Z = o.copy(),
      S = En(G || x, m),
      mn,
      yn,
  ...
  return (
    (f.filter = function (d) {
      return arguments.length
        ? ((t = typeof d == "function" ? d : xt(!!d)), f)
        : t;
    }),
    (f.container = function (d) {
      return arguments.length
        ? ((n = typeof d == "function" ? d : xt(d)), f)
        : n;
    }),
    (f.subject = function (d) {
      return arguments.length
        ? ((e = typeof d == "function" ? d : xt(d)), f)
        : e;
    }),
    (f.touchable = function (d) {
      return arguments.length
        ? ((r = typeof d == "function" ? d : xt(!!d)), f)
        : r;
    }),
    (f.on = function () {
...
var ft = 0.7,
  ...
  hi = new RegExp(`^rgb\\(${j},${j},${j}\\)$`),
  di = new RegExp(`^rgb\\(${R},${R},${R}\\)$`),
  pi = new RegExp(`^rgba\\(${j},${j},${j},${ht}\\)$`),
  gi = new RegExp(`^rgba\\(${R},${R},${R},${ht}\\)$`),
  mi = new RegExp(`^hsl\\(${ht},${R},${R}\\)$`),
  yi = new RegExp(`^hsla\\(${ht},${R},${R},${ht}\\)$`),
  $n = {
    aliceblue: 15792383,
...
function dt(t) {
  ...
  return (
    ...
    (n = fi.exec(t))
      ...
      ? vt(n[1], n[2], n[3], n[4])
      : (n = gi.exec(t))
      ? vt((n[1] * 255) / 100, (n[2] * 255) / 100, (n[3] * 255) / 100, n[4])
      : (n = mi.exec(t))
...
function Zt(t, n, e, r) {
  return arguments.length === 1 ? vi(t) : new b(t, n, e, r ?? 1);
}
function b(t, n, e, r) {
...
ln(
  ...
  ne(yt, {
    ...
    clamp() {
      return new b(z(this.r), z(this.g), z(this.b), Lt(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function wi() {
  return `#${U(this.r)}${U(this.g)}${U(this.b)}${U(
    (isNaN(this.opacity) ? 1 : this.opacity) * 255
  )}`;
}
function An() {
  const t = Lt(this.opacity);
  return `${t === 1 ? "rgb(" : "rgba("}${z(this.r)}, ${z(this.g)}, ${z(
    this.b
  )}${t === 1 ? ")" : `, ${t})`}`;
}
function Lt(t) {
...
function ee(t) {
  ...
  if ((t instanceof yt || (t = dt(t)), !t)) return new A();
...
function bi(t, n, e, r) {
  return arguments.length === 1 ? ee(t) : new A(t, n, e, r ?? 1);
}
function A(t, n, e, r) {
...
ln(
  ...
  ne(yt, {
    ...
    clamp() {
      return new A(Mn(this.h), wt(this.s), wt(this.l), Lt(this.opacity));
    },
    displayable() {
      return (
...
function Ii(t) {
  return (t = +t) == 1
    ? ie
    : function (n, e) {
        return e - n ? $i(n, e, t) : re(isNaN(n) ? e : n);
      };
}
function ie(t, n) {
  var e = n - t;
  return e ? Ei(t, e) : re(isNaN(t) ? n : t);
}
...
function Ni(t, n) {
  var e = (Qt.lastIndex = zt.lastIndex = 0),
    r,
    i,
    o,
    s = -1,
    c = [],
    a = [];
  for (t = t + "", n = n + ""; (r = Qt.exec(t)) && (i = zt.exec(n)); )
    (o = i.index) > e &&
...
function Ai(t) {
  ...
  return n.isIdentity ? Jt : oe(n.a, n.b, n.c, n.d, n.e, n.f);
}
function Ti(t) {
  return t == null ||
    ...
    ? Jt
    : ((t = t.matrix), oe(t.a, t.b, t.c, t.d, t.e, t.f));
}
function se(t, n, e, r) {
  function i(l) {
  ...
  function o(l, u, h, f, p, y) {
    if (l !== h || u !== f) {
      ...
      y.push({ i: _ - 4, x: X(l, h) }, { i: _ - 2, x: X(u, f) });
  ...
  return function (l, u) {
    ...
    return (
      ...
      (l = u = null),
      function (p) {
        for (var y = -1, _ = f.length, N; ++y < _; ) h[(N = f[y]).i] = N.x(p);
        return h.join("");
      }
    );
  };
}
var Mi = se(Ai, "px, ", "px)", "deg)"),
  Pi = se(Ti, ", ", ")", ")"),
  nt = 0,
  it = 0,
  rt = 0,
...
Gt.prototype = le.prototype = {
  constructor: Gt,
  restart: function (t, n, e) {
    if (typeof t != "function")
      throw new TypeError("callback is not a function");
    (e = (e == null ? un() : +e) + (n == null ? 0 : +n)),
      !this._next &&
        ot !== this &&
...
function jt(t) {
  if (!nt) {
    ...
    var n = t - W;
    n > 24
      ? (t < 1 / 0 && (it = setTimeout(Rn, t - pt.now() - Ht)),
        rt && (rt = clearInterval(rt)))
      : (rt || ((Ot = pt.now()), (rt = setInterval(Bi, ce))), (nt = 1), ae(Rn));
  }
}
function Bn(t, n, e) {
  var r = new Gt();
...
var Di = sn("start", "end", "cancel", "interrupt"),
  Oi = [],
  ue = 0,
  Ln = 1,
  tn = 2,
...
function fn(t, n) {
  var e = T(t, n);
  if (e.state > ue) throw new Error("too late; already scheduled");
  return e;
}
function B(t, n) {
  var e = T(t, n);
...
function Gi(t, n, e) {
  ...
  function s(l) {
    ...
    if (
      (Bn(function () {
        e.state === kt &&
          ((e.state = Dn), e.timer.restart(c, e.delay, e.time), c(l));
      }),
      (e.state = tn),
      ...
      for (
        e.state = kt, i = new Array((f = e.tween.length)), u = 0, h = -1;
        u < f;
        ++u
      )
    ...
    for (
      var u =
          l < e.duration
            ...
            : (e.timer.restart(a), (e.state = nn), 1),
        h = -1,
        f = i.length;
      ++h < f;
      ...
      i[h].call(t, u);
    e.state === nn && (e.on.call("end", t, t.__data__, e.index, e.group), a());
  }
  function a() {
...
function Yi(t, n) {
  ...
  return this.each((n == null ? Vi : Fi)(e, t, n));
}
function hn(t, n, e) {
  var r = t._id;
  return (
...
function Qi(t, n) {
  ...
  return this.attrTween(
    t,
    typeof n == "function"
      ? (e.local ? Zi : Ki)(e, r, hn(this, "attr." + t, n))
      : n == null
      ? (e.local ? Ui : qi)(e)
      : (e.local ? Wi : zi)(e, r, n)
  );
...
function eo(t, n) {
  ...
  var r = Xt(t);
  return this.tween(e, (r.local ? to : no)(r, n));
}
function ro(t, n) {
  return function () {
...
function ao(t) {
  var n = this._id;
  return arguments.length
    ? this.each((typeof t == "function" ? so : co)(n, t))
...
function uo(t) {
  var n = this._id;
  return arguments.length ? this.each(lo(n, t)) : T(this.node(), n).ease;
}
function fo(t, n) {
  return function () {
    var e = n.apply(this, arguments);
    ...
    for (var a = r[c], l = a.length, u, h = 0; h < l; ++h)
      if ((u = a[h])) {
        for (
          ...
          (p = f[_]) && Vt(p, n, e, _, f, y);
        o.push(f), s.push(u);
      }
  return new O(o, s, n, e);
}
var Eo = mt.prototype.constructor;
function $o() {
...
function No(t, n) {
  ...
  return function () {
    var a = B(this, t),
      l = a.on,
      u = a.value[o] == null ? c || (c = he(n)) : void 0;
    (l !== e || i !== u) && (r = (e = l).copy()).on(s, (i = u)), (a.on = r);
  };
}
function Ao(t, n, e) {
  var r = (t += "") == "transform" ? Mi : fe;
  return n == null
    ? this.styleTween(t, Io(t, r)).on("end.style." + t, he(t))
    : typeof n == "function"
    ? this.styleTween(t, Co(t, r, hn(this, "style." + t, n))).each(
        No(this._id, t)
      )
    : this.styleTween(t, ko(t, r, n), e).on("end.style." + t, null);
}
function To(t, n, e) {
  return function (r) {
...
var Fo = { time: null, delay: 0, duration: 250, ease: Vo };
function Yo(t, n) {
...
function qo(t) {
  ...
  t instanceof O
    ? ((n = t._id), (t = t._name))
    : ((n = de()), ((e = Fo).time = un()), (t = t == null ? null : t + ""));
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, a, l = 0; l < c; ++l)
      (a = s[l]) && Vt(a, t, n, l, s, e || Yo(a, n));
  return new O(r, this._parents, t, n);
}
mt.prototype.interrupt = Hi;
mt.prototype.transition = qo;
const en = Math.PI,
  rn = 2 * en,
  Y = 1e-6,
  Uo = rn - Y;
    ...
    if (this._x1 === null) this._append`M${(this._x1 = n)},${(this._y1 = e)}`;
      ...
      if (!(Math.abs(h * a - l * u) > Y) || !o)
        ...
        let p = r - s,
          ...
          K = Math.sqrt(_),
          M = Math.sqrt(f),
          P = o * Math.tan((en - Math.acos((_ + f - N) / (2 * K * M))) / 2),
          d = P / M,
          m = P / K;
    ...
    this._x1 === null
      ...
      r &&
        ...
        f > Uo
          ...
          : f > Y &&
            this._append`A${r},${r},0,${+(f >= en)},${h},${(this._x1 =
...
const V = document.getElementById("svg");
V || console.error("SVG container not found");
const q = (V == null ? void 0 : V.offsetWidth) || window.innerWidth,
  es =
    (V != null && V.offsetTop
      ? window.innerHeight - V.offsetTop
      : window.innerHeight) || 400,
  rs = window.innerWidth < 850,
  On = {
    desktop: {
      raspberry: { scale: 1, x: 0, y: 0 },
      sensor: { scale: 0.45, x: 150, y: 25 },
      object: { scale: 0.5, x: 500, y: 25 },
      bluetooth: { scale: 0.5, x: 500, y: 25 },
      phone: { scale: 0.5, x: 500, y: 25 },
      bconnect: { scale: 0.5, x: 500, y: 25 },
    },
    mobile: {
      raspberry: { scale: 0.5, x: q * 0.1, y: 10 },
      sensor: { scale: 0.225, x: q * 0.3, y: 50 },
      object: { scale: 0.25, x: q * 0.5, y: 50 },
      bluetooth: { scale: 0.25, x: q * 0.7, y: 50 },
      phone: { scale: 0.25, x: q * 0.3, y: 50 },
      bconnect: { scale: 0.25, x: q * 0.5, y: 100 },
    },
  },
  g = rs ? On.mobile : On.desktop,
  is = Math.max(
    g.raspberry.x + 400 * g.raspberry.scale,
    g.sensor.x + 200 * g.sensor.scale,
    g.object.x + 100 * g.object.scale,
    g.bluetooth.x + 100 * g.bluetooth.scale,
    g.phone.x + 100 * g.phone.scale,
    g.bconnect.x + 100 * g.bconnect.scale
  ),
  os = Math.max(
    g.raspberry.y + 200 * g.raspberry.scale,
    g.sensor.y + 100 * g.sensor.scale,
    g.object.y + 100 * g.object.scale,
    g.bluetooth.y + 100 * g.bluetooth.scale,
    g.phone.y + 100 * g.phone.scale,
    g.bconnect.y + 100 * g.bconnect.scale
  ),
  ss = Math.max(q, is + 50),
  cs = Math.max(es, os + 50),
  w = E("#svg")
    .append("svg")
    .attr("id", "svgContainer")
    .attr("viewBox", `0 0 ${ss} ${cs}`)
  ...
  dn = w.append("g").attr("id", "pathsGroup"),
  pn = {
    rasberryPi:
  ...
  at = document.getElementById("sensor"),
  lt = document.getElementById("object"),
  Nt = document.getElementById("info"),
  on = document.getElementById("list"),
  gt = document.getElementById("displayInfo"),
  At = document.getElementById("codeSubmit"),
  Q = document.getElementById("componentDescription"),
  Tt = document.getElementById("undoButton"),
  Mt = document.getElementById("closeCodeDrawer"),
  Pt = document.getElementById("codeButton"),
  St = document.getElementById("resetButton");
ct || console.error("Raspberry Pi component not found");
at || console.error("Sensor component not found");
lt || console.error("Object component not found");
Nt || console.error("Info button not found");
on || console.error("List element not found");
gt || console.error("Display info element not found");
At || console.error("Code submit button not found");
Tt || console.error("Undo button not found");
Mt || console.error("Close code drawer button not found");
Pt || console.error("Code button not found");
St || console.error("Reset button not found");
ct == null ||
  ct.addEventListener("click", async () => {
    console.log("Raspberry Pi clicked"), await as.load();
  });
at == null ||
  at.addEventListener("click", () => {
    console.log("Sensor clicked"), ls.load();
  });
lt == null ||
  ...
  t == null ||
    t.addEventListener("mouseover", () => {
      console.log("Hovering over component:", n),
        Q && ((Q.textContent = n), (Q.style.display = "block"));
    }),
    t == null ||
      t.addEventListener("mouseout", () => {
        console.log("Mouse out from component"),
          Q &&
            ((Q.textContent = "Hover over a component to see its description."),
...
Nt == null ||
  Nt.addEventListener("click", () => {
    console.log("Info button clicked, showList:", $t),
      ($t = !$t),
      on && (on.style.display = $t ? "block" : "none");
  });
Pt == null ||
...
Tt == null ||
  Tt.addEventListener("click", () => {
    console.log("Undo button clicked"), F.undoLastConnection(), gs();
  });
Mt == null ||
...
At == null ||
  At.addEventListener("click", () => {
    ...
    const t = jo(F.getConnectionLog());
    if (t === !0) {
      const e =
          (n = document.getElementById("inputValue")) == null
            ? void 0
            : n.value,
        r = document.getElementById("tspan4567");
      r && e && (r.textContent = e);
    } else
      t.error
        ? Vn.throw("Error", t.error)
        : Vn.throw(
            "Error",
...
const Hn = (t) =>
  D.includes(t.srcElement.id) ||
  ge.includes(t.srcElement.id) ||
  me.includes(t.srcElement.id);
let k;
const F = new ts("connectionLog"),
  Vn = new ns("errorBox", "errorHeading", "errorText", "closeErrorBox");
let C = 0;
const ps = (t) => {
    dn.selectAll(`path[id="${t}"]`)
      .nodes()
      .forEach((e) => e.remove());
  },
  gs = () => {
    if (k) {
      dn.selectAll(`path[id^="path${C}"]`)
        .nodes()
        .forEach((e) => e.remove());
      const n = w.select(`#marker-start-${C}`);
      n.empty() || n.remove(),
        (k = null),
    ...
    if (F.connections.length > 0) {
      ...
      r.empty() || i.remove(),
        D.includes(t.connector) &&
          E(`#${t.connector}`).style("fill", "#9a916c"),
        t.connectorEnd &&
          D.includes(t.connectorEnd) &&
...
w.on("dblclick", (t) => {
  if (
    ...
    (k = new Wo()),
      ...
      D.includes(t.srcElement.id)
        ...
        : Xn(t.offsetX, t.offsetY, `marker-start-${C}`),
      F.addConnection({
        lineID: `path${C}`,
        x: t.offsetX,
        y: t.offsetY,
  ...
  if (t.srcElement.id === "svgContainer" && !D.includes(t.srcElement.id)) {
    k &&
      (k.lineTo(t.offsetX, t.offsetY),
      Gn(k.toString(), `path${C}`),
  ...
  if (Hn(t) && k) {
    k.lineTo(t.offsetX, t.offsetY),
      ...
      D.includes(t.srcElement.id)
        ? E(`#${t.srcElement.id}`).style("fill", "black")
        : Xn(t.offsetX, t.offsetY, `marker-end-${C}`),
      F.addConnection({
        lineID: `path${C}`,
        x: t.offsetX,
        y: t.offsetY,
...
w.on("mouseover", (t) => {
  D.includes(t.srcElement.id) &&
    ...
    gt && (gt.innerHTML = H[t.srcElement.id]));
});
w.on("mouseout", (t) => {
  (D.includes(t.srcElement.id) ||
    ge.includes(t.srcElement.id) ||
    ...
    gt && (gt.innerHTML = "CONNECTOR INFO"));
});
